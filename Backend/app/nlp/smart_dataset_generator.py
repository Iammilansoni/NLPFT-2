"""
Smart Dataset Generator - Generate and expand datasets using Gemini API
Handles intelligent dataset creation with edge cases and variations
Now dynamically loads templates from template service
"""
...
def get_dataset_generator() -> SmartDatasetGenerator:
    """Get or create global SmartDatasetGenerator instance"""
    global _generator
    if _generator is None:
        _generator = SmartDatasetGenerator()
    return _generator
